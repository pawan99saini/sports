...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/style.css?ver=1.1.3">
        <link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/ionicons.min.css">
        <link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/main-new.css?ver=2.3.12">
        <link rel="stylesheet" href="<?= base_url(); ?>assets/frontend/css/responsive.css?ver=1.3.12">
