<section class="dso-inner-banner tournaments-main">
    <div class="full-width">
        <img src="<?= base_url(); ?>assets/frontend/images/tournament-banner.png" />
    </div>
</section>

<section class="dso-main">
    <div class="container">
        <div class="categories-nav">
            <ul class="categories games-categories">
                <?php 
                ...
                ?>
                            <li>
                                <a href="<?= base_url(); ?>tournaments/<?= $game->category_slug . '/' . $game->slug; ?>">
                                    ...
                                    <div class="dso-hover-effect"></div>
                                </a>
                            </li>
                <?php 
                        }
        ...
        <div class="dso-tabs">
            <a href="<?= base_url(); ?>home/getTournaments/upcoming" class="btn dso-ebtn dso-ebtn-outline get-tournaments" data-category="<?= $category_slug; ?>" data-game="<?= $game_slug; ?>">
                <span class="dso-btn-text">Upcoming Tournaments</span>
                <div class="dso-btn-bg-holder"></div>
            </a>

            <a href="<?= base_url(); ?>home/getTournaments/ongoing" class="btn dso-ebtn dso-ebtn-solid get-tournaments" data-category="<?= $category_slug; ?>" data-game="<?= $game_slug; ?>">
                <span class="dso-btn-text">Ongoing Tournaments</span>
                <div class="dso-btn-bg-holder"></div>
            </a>            

            <a href="<?= base_url(); ?>home/getTournaments/community" class="btn dso-ebtn dso-ebtn-outline get-tournaments" data-category="<?= $category_slug; ?>" data-game="<?= $game_slug; ?>">
                <span class="dso-btn-text">Community Tournaments</span>
                <div class="dso-btn-bg-holder"></div>
            </a>
        </div>
        ...
        <div style="position: relative;">
            ...
            <div class="loader-full"  id="tournament-load">
        ...
        <?php if(count($tournamentsData) > 9) { ?>
        <div class="loadmore">
            <a href="<?= base_url() . 'home/loadTournaments'; ?>" class="load-tournaments btn dso-ebtn dso-ebtn-solid" data-offset="<?= $j; ?>">
                <span class="dso-btn-text">Load More</span>
                <div class="dso-btn-bg-holder"></div>
            </a>
        </div>
        <?php } ?>
...
<input type="hidden" name="tournaments_type" value="active-tournaments" />
<input type="hidden" name="tournaments_category" value="" />