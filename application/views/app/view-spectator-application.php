            ...
            <div class="card-body">
                <div class="col-md-12 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <a href="<?= base_url(); ?>member/getApplications" class="btn btn-info d-none d-lg-block m-l-15 back-applications">
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane active" id="activity" role="tabpanel">
                        ...
                        <form method="POST" action="<?php echo base_url(); ?>member/updateSpectator" onsubmit="return false;" class="updateSpectator">
