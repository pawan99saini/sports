            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                     <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/tournaments/notice-board">Notice Board</a></li>
                        <li class="breadcrumb-item active">Create Notice</li>
                    </ol>

                    <a href="<?= base_url(); ?>admin/tournaments/notice-board/<?= $tournamentID; ?>" class="btn btn-info d-none d-lg-block m-l-15">
