								...
								<div class="form-group col-12">
                                    <div class="row-box-spacer">
                                        <h5 class="card-subtitle clearfix col-12">
                                            ...
                                            <a href="javascript:void(0);" class="add-custom-fields btn btn-info btn-right">
                                        ...
                                        <div class="stats-row">
                                            ...
                                            <?php foreach($metaData as $meta): ?>
                                                <div class="input-row mg-b-20">
                                                    <input type="text" name="metaData[meta_key]" class="form-control" value="<?= $meta->meta_key; ?>" value="" autocomplete="off" />
                                                    <input type="text" name="metaData[meta_value]" class="form-control" value="<?= $meta->meta_value; ?>" value="" autocomplete="off" />
                                            ...
                                            <?php } else { ?>
                                                <div class="input-row mg-b-20">
                                                    <input type="text" name="metaData[meta_key]" class="form-control" placeholder="Title" value="" autocomplete="off" />
                                                    <input type="text" name="metaData[meta_value]" class="form-control" placeholder="Description" value="" autocomplete="off" />
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </div>
