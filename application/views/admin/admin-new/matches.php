    ...
    <div class="main-container container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <span class="main-content-title tx-primary mg-b-0 mg-b-lg-1">Tournament Matches</span>
            </div>
            <div class="justify-content-center align-items-center d-flex mt-2">
                <ol class="breadcrumb breadcrumb-style3">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tournament Matches</li>
                </ol>

                <?php if(isset($tournamentID)) { ?>
                    <?php if(count($matchesData) == 0) { ?>  
                    <a href="<?php echo base_url(); ?>admin/matches/manage/<?= $tournamentID; ?>/create" class="btn btn-primary d-none d-lg-block m-l-15">
                            ...
                            <?php if($tournamentData[0]->status > 1) { ?> 
                                ...
                                <?php if(count($matchesData) == 0) { ?>
                                    <div class="table-responsive m-t-40">
                                        <table class="table table-bordered text-nowrap border-bottom players-match-table" id="basicDataTable">
                                            <thead>
                                                <tr>
                                                    <th>#ID</th>
                                                    <th>Player 1</th>
