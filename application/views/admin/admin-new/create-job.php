                                        ...
                                        <div class="stats-row">
                                            ...
                                            <?php foreach($metaData as $meta): ?>
                                                <div class="input-row mg-b-20">
                                                    <input type="text" name="meta_key[]" class="form-control" value="<?= $meta->meta_key; ?>" value="" autocomplete="off" />
                                                    <input type="text" name="meta_value[]" class="form-control" value="<?= $meta->meta_value; ?>" value="" autocomplete="off" />
                                            ...
                                            <?php } else { ?>
                                                <div class="input-row mg-b-20">
                                                    <input type="text" name="meta_key[]" class="form-control" placeholder="Title" value="" autocomplete="off" />
                                                    <input type="text" name="meta_value[]" class="form-control" placeholder="Description" value="" autocomplete="off" />
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </div>
