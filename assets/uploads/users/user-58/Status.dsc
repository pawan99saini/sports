...
bot_status_update:
  ...
  - if <server.flag[statistics_chart].get[time].first.if_null[null]> != null:
      ...
      - define chart_url <[chart_url]>title=Kingdom%20Craft%20Survival&labels=<[labels]>&data1=<[player_count_data]>&data2=<[tps_data]>

      # ex ~discordmessage id:bot channel:<discord_channel[1019125403316654180]> <discord_embed.with[author_name].as[Hi]>
  ...
  - define author_icon_url https://i.imgur.com/wvaJ3DI.png
  - define thumbnail https://i.imgur.com/wvaJ3DI.png
  ...
  - ~discordmessage id:bot edit:1019125526369161226 channel:<discord_channel[1019125403316654180]> <[status].with[color].as[yellow]>